                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        RaisedButton(onPressed:()=> Navigator.of(context).pushNamed(ChatScreen.routeName,arguments: 'NorthAndMiddleAndaman'),child:Text("Join"),),
                      ],
                    ),
                  ),
                  Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        RaisedButton(onPressed: ()=> Navigator.of(context).pushNamed(ChatScreen.routeName,arguments: 'SouthAndaman'),child:Text("Join"),),
                      ],
                    ),
                        ),
                        Container(
                      ...
                      children: <Widget>[
                        ...
                        RaisedButton(onPressed:()=> Navigator.of(context).pushNamed(ChatScreen.routeName,arguments: 'Nicobar'),child:Text("Join"),),
                      ],
                    ),
                        ),
